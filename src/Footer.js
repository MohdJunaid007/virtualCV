    ...
    >
      <div className='colz'>
        <div className='colz-icon'>
          ...
          <a href='http://facebook.com/100010587555186/' target='_blank'>
            <i className='fa fa-facebook-square icons'>  </i>
          </a>
          <a href='mailto:junaid.iiitk@gmail.com' target='_blank'>
            <i className='fa fa-envelope-o icons'></i>
          </a>
          <a href='https://www.instagram.com/mohd___junaid_/' target='_blank'>
            <i className='fa fa-instagram icons'></i>
          </a>
          <a href='https://www.linkedin.com/in/junaid001/' target='_blank'>
            <i className='fa fa-linkedin-square icons'></i>
          </a>
          <a href='https://github.com/MohdJunaid007' target='_blank'>
