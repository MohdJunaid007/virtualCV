                    ...
                    <div className='service__box pointer'>
                        ...
                        <div className='service__meta'>
                            ...
                            <p className='service__text p__color'>
                                HTML, CSS, JavaScript, ReactJS, React Native, Bootstrap, Tailwind CSS, TypeScript, Node.js, MongoDB, MySQL, Express.js, UI/UX design, Canva etc
                            </p>
                ...
                <div className='col__3'>
                    <div className='service__box pointer'>
                        ...
                        <div className='service__meta'>
                            ...
                            <p className='service__text p__color'>
                                C/C++ Programming Languages, SQL, Data Structures and Algorithm, Object-Oriented Programming, Operating System, Database Management System, Computer Networks
                            </p>
                        </div>
                    </div>
                ...
                <div className='col__3'>
                    <div className='service__box pointer'>
                        ...
                        <div className='service__meta'>
                            ...
                            <p className='service__text p__color'>
                                VS Code, Git, Github, Chess, Collaboration, Communication, Team work, Leadership, Time management, Problem solving skills
                            </p>
                        </div>
                    </div>
